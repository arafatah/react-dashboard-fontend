        ...
        <NavLink
          ...
          className={({ isActive, isPending }) =>
            isPending
              ? "pending"
              : isActive
              ? "font-bold text-[#FD0054] underline"
              : ""
          }
        >
          Home
    ...
    <div className="bg-base-200">
      <div className="navbar container mx-auto px-5 py-5">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="flex gap-7 px-1">{navLink}</ul>
        </div>
        <div className="navbar-end">
          <div className="mr-2">
            {user ? (
              <div className="flex gap-2 md:gap-4">
                ...
                <Link to="/login" className="flex items-center">
                  <button
                    ...
                    className="bg-[#FD0054] border-0 text-white p-2 rounded-lg"
                  >
                    <LuLogOut></LuLogOut>
                  </button>
                </Link>
              ...
              <>
                <Link to="/login">
                  <button className="bg-[#FD0054] border-0 text-white p-2 md:p-3 px-1 md:px-4 rounded-lg text-sm md:text-xl">
                    Login
                  </button>
                </Link>
              </>
